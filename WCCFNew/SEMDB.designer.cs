...
namespace WCCFNew
{
    ...
    partial void InsertContactPlace(ContactPlace instance);
    partial void UpdateContactPlace(ContactPlace instance);
    partial void DeleteContactPlace(ContactPlace instance);
    ...
    partial void DeleteTwitter(Twitter instance);
		...
		public System.Data.Linq.Table<ContactPlace> ContactPlaces
		{
			get
			{
				return this.GetTable<ContactPlace>();
			}
		}
    ...
    partial void OnzipChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StreetAddress", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_address", Storage="_User", ThisKey="User_UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ContactPlace")]
	public partial class ContactPlace : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnPhoneChanging(bool value);
    ...
    partial void OnFacebookChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Phone", DbType="Bit NOT NULL")]
		public bool Phone
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ContactPlace", Storage="_User", ThisKey="User_UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._User.Entity = null;
						previousValue.ContactPlace = null;
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.ContactPlace = this;
						this._User_UserID = value.UserID;
					}
					else
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ContactTime")]
    ...
    partial void OnEveningChanging(bool value);
    partial void OnEveningChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Evening", DbType="Bit NOT NULL")]
		public bool Evening
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ContactTime", Storage="_User", ThisKey="User_UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._User.Entity = null;
						previousValue.ContactTime = null;
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.ContactTime = this;
						this._User_UserID = value.UserID;
					}
					else
					{
    ...
    partial void OnPhone1Changed();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="Phone", Storage="_Phone1", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Phone", Storage="_User", ThisKey="User_UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ContactPlace> _ContactPlace;
		
		private EntityRef<ContactTime> _ContactTime;
    ...
    partial void OnisSubbedChanged();
		...
		public User()
		{
			...
			this._ContactPlace = default(EntityRef<ContactPlace>);
			this._ContactTime = default(EntityRef<ContactTime>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_address", Storage="_address", ThisKey="UserID", OtherKey="User_UserID", IsUnique=true, IsForeignKey=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ContactPlace", Storage="_ContactPlace", ThisKey="UserID", OtherKey="User_UserID", IsUnique=true, IsForeignKey=false)]
		public ContactPlace ContactPlace
		{
			get
			{
				return this._ContactPlace.Entity;
			}
			set
			{
				ContactPlace previousValue = this._ContactPlace.Entity;
				if (((previousValue != value) 
							|| (this._ContactPlace.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ContactPlace.Entity = null;
						previousValue.User = null;
					}
					this._ContactPlace.Entity = value;
					if ((value != null))
					{
						value.User = this;
					}
					this.SendPropertyChanged("ContactPlace");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_ContactTime", Storage="_ContactTime", ThisKey="UserID", OtherKey="User_UserID", IsUnique=true, IsForeignKey=false)]
		public ContactTime ContactTime
		{
			get
			{
				return this._ContactTime.Entity;
			}
			set
			{
				ContactTime previousValue = this._ContactTime.Entity;
				if (((previousValue != value) 
							|| (this._ContactTime.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ContactTime.Entity = null;
						previousValue.User = null;
					}
					this._ContactTime.Entity = value;
					if ((value != null))
					{
						value.User = this;
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Phone", Storage="_Phone", ThisKey="UserID", OtherKey="User_UserID", IsUnique=true, IsForeignKey=false)]
		public Phone Phone
		{
			get
			{
